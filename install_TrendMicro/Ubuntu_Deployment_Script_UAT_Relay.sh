...
/opt/ds_agent/dsa_control -a $ACTIVATIONURL "policyid:13" "relaygroupid:2"
# /opt/ds_agent/dsa_control -a dsm://RyOfPrimTmP01.geidea.net:4120/ "policyid:13" "relaygroupid:2"
